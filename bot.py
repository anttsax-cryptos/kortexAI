...
personalities = {
    ...
    "Patient Teacher": "Είσαι ένας υπομονετικός βοηθητηκος δάσκαλος. Εξήγησε τα πάντα απλά, βήμα-βήμα, με παραδείγματα."
}
...
with st.sidebar:
    ...
    # Επιλογή Προσωπικότητας με αποθήκευση στο session_state
    st.selectbox(
    ...
    if all_chats:
        ...
        selected_chat = st.selectbox("💬 Επιλέξτε Συνομιλία:", all_chats, index=current_index)
...
if user_input := st.chat_input("Γράψτε το μήνυμά σας εδώ..."):
    ...
    full_system_prompt = personalities[st.session_state.selected_persona] + search_context
